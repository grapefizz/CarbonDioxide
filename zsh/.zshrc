...
export FZF_DEFAULT_OPTS='--color="bg+:#262626,bg:#161616,spinner:#ff7eb6,hl:#42be65,fg:#dde1e6,header:#78a9ff,info:#be95ff,pointer:#ff7eb6,marker:#3ddbd9,fg+:#ffffff,prompt:#be95ff,hl+:#42be65"'
